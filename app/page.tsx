      ...
      <div className="flex flex-col min-h-screen bg-gray-50 font-sans">
        <div className="flex grow max-w-7xl mx-auto w-full py-8 px-4 gap-8">
          ...
          <main className="grow lg:ml-72">
            <h1 className="text-3xl font-bold text-[#002a5c] mb-8">
              Product Listing
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredProducts.map((product) => (
                <Link
                  ...
                  className="relative group h-95 w-full"
                >
                  <div className="absolute inset-0 bg-white p-4 rounded-2xl shadow-sm border border-transparent flex flex-col transition-opacity duration-200 group-hover:opacity-0 pointer-events-none">
                    ...
                    <h3 className="text-lg font-semibold text-[#002a5c] mb-1">
                      {product.name}
                    </h3>
                    ...
                    <button
                      className="mt-auto w-full bg-[#0056b3] text-white py-2.5 rounded-lg font-medium"
                      onClick={() =>
                        addToCart({
                          id: product.id,
                          name: product.name,
                  ...
                  >
                    ...
                    <div className="w-3/5 flex flex-col text-left gap-">
                      <Link
                        ...
                        className="relative group h-95 w-full"
                      >
                        <h3 className="text-lg font-bold text-[#002a5c]">
                          {product.name}
                        </h3>
                      ...
                      <button
                        className="w-full bg-[#0056b3] text-white py-2 rounded-lg text-sm font-medium hover:bg-[#004494] transition-colors shadow-sm cursor-pointer"
                        onClick={() =>
                          addToCart({
                            id: product.id,
                            name: product.name,
